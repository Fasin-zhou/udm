...
class PlansModelListSerializers(serializers.ListSerializer):

    def create(self, validated_data):
        create_cases = [PlansModel(**item) for item in validated_data]
        return PlansModel.objects.bulk_create(create_cases)
...
class PlansSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = PlansModel
        fields = '__all__'
        list_serializer_class = PlansModelListSerializers
